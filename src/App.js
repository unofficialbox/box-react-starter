  ...
  return (
      <Router>
        <Switch>
          ...
          <Route exact path="/explorer/:folderId" render={(props) => <ContentExplorer folderId={'0'}/>}/>
          ...
          <Route exact path="/picker/:folderId" render={(props) => <ContentPicker  folderId={'0'}/>}/>
          {/* <Route exact path="/uploader/:folderId" render={(props) => <ContentUploader  folderId={props.match.params.folderId}/>}/> */}
          <Route exact path="/uploader/:folderId" render={(props) => <ContentUploader  folderId={'0'}/>}/>
